...
void initVulkan()
{
    ...
    VKBackend::renderPass = VKBackend::createRenderPass1Sample(VKBackend::device);
...
void createDepthResources()
{
    ...
    VKBackend::createImage(VKBackend::swapChainExtent.width, VKBackend::swapChainExtent.height, VK_SAMPLE_COUNT_1_BIT, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
